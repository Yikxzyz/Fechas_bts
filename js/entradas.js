(function () {
  ...
  function renderCard(row) {
    ...
    // Badge de ubicación / modalidad de entrega
    ...
    var ubicacionHtml;
    if (resideRaw === "si" && presencialRaw === "si" && ciudadRaw) {
      // Reside en Chile y acepta encuentro presencial → muestra ciudad
      ubicacionHtml = '<span class="listing-ubicacion listing-ubicacion--presencial">📍 ' + ciudadRaw + '</span>';
    } else {
      // No reside en Chile o no quiere juntarse → venta online
      ubicacionHtml = '<span class="listing-ubicacion listing-ubicacion--online">🌐 Venta online</span>';
    }
    ...
    return (
      ...
      '<div class="listing-header-right">' + ubicacionHtml + '<span class="listing-badge">Verificado ✓</span></div>' +
      "</div>" +
